...
//        System.out.println("\n> Insertion sorting:");
        long insertionSortTime = SorterManager.getSortingTime(a1, new InsertionSorter());
//        printArray(a1);

//        System.out.println("\n> Quick sorting:");
        long quickSortTime = SorterManager.getSortingTime(a2, new QuickSorter());
//        printArray(a2);

//        System.out.println("\n> Shell sorting:");
        long shellSortTime = SorterManager.getSortingTime(a3, new ShellSorter());
//        printArray(a3);
